...
# Max Effect, make missing baseline week stress = 5
# missing treatment week stress = 1
...
```{r}
# Min Effect, make missing baseline week stress = 1
# missing treatment week stress = 5
